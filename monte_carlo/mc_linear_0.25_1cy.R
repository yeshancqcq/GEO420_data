...
plot <- plot + scale_x_reverse(limits = c(30000, 0.1),breaks = scales::pretty_breaks(n = 20)) +
  ggtitle("Number of SVZ Events Over Time, Normalized to 30000 Years BP (Linear)","Monte Carlo Simulation for 1000 Times, Assume 25% Records Are Preserved at 30000 Years BP") +
